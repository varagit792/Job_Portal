...
const ReactPaginateItems = ({ itemsPerPage, setItemOffset, items }: any) => {
    ...
    return (
        <ReactPaginate
            ...
            previousLinkClassName="relative block py-2 px-3 -ml-0.5 leading-tight text-black bg-white border border-[#dee2e6] hover:cursor-pointer hover:bg-[#dee2e6]"
            nextClassName="[&.active>a]:bg-blue-300"
            nextLinkClassName="relative block py-2 px-3 -ml-0.5 leading-tight text-black bg-white border border-[#dee2e6] hover:cursor-pointer hover:bg-[#dee2e6]"
