    ...
    return (
        <div className="mb-16">
            <div className="flex justify-between items-center mb-10 font-bold">
                ...
                <Link to="/" className="text-base flex justify-center items-center text-[#312E81]"><span className="mr-2">All Applicants</span><img src={ArrowRight} alt="ArrowRight" /></Link>
            </div>
            <Carousel
                swipeable={false}
                draggable={false}
