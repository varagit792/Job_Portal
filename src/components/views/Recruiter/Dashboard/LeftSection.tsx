        ...
        <div className="col-start-1 col-end-3">
            <div className="bg-[#FFF] rounded-lg shadow-sm w-full sticky top-[13%] ">
                ...
                <div className="px-5 py-5">
                    <h1 className="text-xl font-bold mb-1">Dibyalochan Parida</h1>
                    <div>
                        <h1 className="mb-1 overflow-hidden whitespace-nowrap text-ellipsis ">Reactjs Developer
                        </h1>
                        <h1 className="overflow-hidden whitespace-nowrap text-ellipsis">@ Ratnaglobal Tech
                        </h1>
                    </div>
                    <div className="mt-5 text-sm text-[#64748B]">
                        <div className="flex justify-start items-center mb-1">
                            <img src={EmailIcon} alt="EmailIcon" width="12rem" height="12rem" />
                            <span className="ml-2 overflow-hidden inline-block whitespace-nowrap text-ellipsis">dibyalochanparida@gmail.com</span>
                        </div>
                        <div className="flex justify-start items-center mb-1">
                            <img src={PhoneIcon} alt="PhoneIcon" width="12rem" height="12rem" />
                            <span className="ml-2 overflow-hidden inline-block whitespace-nowrap text-ellipsis">7064772937</span>
                        </div>
                    ...
                    <div className="flex justify-start items-center mb-4">
                        ...
                        <h1 className="ml-2 line-clamp-2 list-inside font-bold">TATA Consultancy Services</h1>
                    </div>
