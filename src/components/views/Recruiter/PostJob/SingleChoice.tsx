...
function SingleChoice({ index, register, handlesChange, watch, handleDoneStatusChange, doneStatus }: any) {
  return (
    <>
        ...
        <div className="w-full flex-col justify-start items-start gap-3 flex">
          <div className="w-full h-12 border-b border-slate-200 justify-start items-center inline-flex">
            <div className="grow shrink basis-0 h-6 justify-start items-center gap-2 flex">
              ...
              <div className="text-black text-base font-normal leading-snug tracking-tight">Yes</div>
            </div>
